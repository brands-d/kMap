...
class TestLMFitModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        orbital_paths = ["PTCDA_C.cube", "PTCDA_D.cube", "PTCDA_E.cube", "PTCDA_F.cube"]
        cls.orbitals = [
    ...
    def setUp(self):
        self.lmfit = LMFitModel(TestLMFitModel.sliced_data, TestLMFitModel.orbitals)
    ...
    def test_set_background_equation(self):
        ...
        self.assertRaises(ValueError, self.lmfit.set_background_equation, "np.exp(a")
    ...
    def test_settings(self):
        lmfit_new = LMFitModel(TestLMFitModel.sliced_data, TestLMFitModel.orbitals)
    ...
    def test_PTCDA(self):
        ...
        self.lmfit.edit_parameter("angle", value=40)

...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.photon_label.setObjectName(u"photon_label")
        ...
        self.photon_spinbox.setObjectName(u"photon_spinbox")
        ...
        self.broadening_label.setObjectName(u"broadening_label")
        ...
        self.broadening_spinbox.setObjectName(u"broadening_spinbox")
        self.broadening_spinbox.setFont(font1)
        self.broadening_spinbox.setAlignment(Qt.AlignCenter)
        self.broadening_spinbox.setCorrectionMode(QAbstractSpinBox.CorrectToNearestValue)
    ...
    def retranslateUi(self, window):
        ...
        self.other_groupbox.setTitle(QCoreApplication.translate("window", u"Other Options", None))
        self.photon_label.setText(QCoreApplication.translate("window", u"Photon Energy:", None))
        self.photon_spinbox.setSuffix(QCoreApplication.translate("window", u"  eV", None))
        ...
        self.broadening_label.setText(QCoreApplication.translate("window", u"Energy Broadening:", None))
        self.broadening_spinbox.setSuffix(QCoreApplication.translate("window", u"  eV", None))

...
class Ui_orbitaldatatab(object):
    def setupUi(self, orbitaldatatab):
        if not orbitaldatatab.objectName():
            orbitaldatatab.setObjectName("orbitaldatatab")
        ...
        self.real_space_options.setObjectName("real_space_options")

        self.layout_2.addWidget(self.real_space_options)

        # self.mini_real_plot = MiniRealSpacePlot(self.layout)
        # self.mini_real_plot.setObjectName("mini_real_plot")
        sizePolicy1 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        # sizePolicy1.setHeightForWidth(
        #    self.mini_real_plot.sizePolicy().hasHeightForWidth()
        # )
        ...
        # self.mini_3Dkspace_plot.setObjectName("mini_3Dkspace_plot")
        ...
        self.polarization_layout.setObjectName("polarization_layout")
        ...
        self.cube_options.setObjectName("cube_options")
        ...
        self.plot_item.setObjectName("plot_item")
    ...
    def retranslateUi(self, orbitaldatatab):
        orbitaldatatab.setWindowTitle(
            QCoreApplication.translate("orbitaldatatab", "Form", None)
        )

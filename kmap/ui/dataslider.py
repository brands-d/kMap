...
################################################################################
## Form generated from reading UI file 'dataslider.ui'
##
...
class Ui_dataslider(object):
    def setupUi(self, dataslider):
        ...
        dataslider.resize(611, 199)
        self.verticalLayout = QVBoxLayout(dataslider)
        ...
        self.transpose_button = QPushButton(self.groupbox)
        self.transpose_button.setObjectName(u"transpose_button")
        self.transpose_button.setFont(font1)
    ...
    def retranslateUi(self, dataslider):
        ...
        self.transpose_button.setText(QCoreApplication.translate("dataslider", u"Swap Axes", None))

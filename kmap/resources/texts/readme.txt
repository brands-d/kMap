<h1 id="kmap">kMap</h1>
<p>kMap is a utility project to display, modify and compare momentum maps of
...
<p>Before installing kMap, please make sure you have a python version of 3.7
...
<p>kMap comes with a complete setup of a virtual environment for kMap only
...
<p>The following commands will set up a venv folder inside the kMap&#39;s root
directory</p>
...
you are doing.</p>
<h4 id="linux-macos-probably-">Linux &amp; MacOS (probably)</h4>
<p>The following commands will install kMap and all necessary packages
inside</p>
...
<p>All configuration files can be found in ./kmap/resources/config. They are
...
you installed kMap. If you decided to use the venv kMap comes with, redo 1. of the installation instruction.</p>
<p>To start kMap simply run</p>
<h3 id="linux-macos-probably-">Linux &amp; MacOS (probably)</h3>
<pre><code>make <span class="hljs-keyword">run</span><span class="bash"></span>
</code></pre><h3 id="windows">Windows</h3>
<pre><code><span class="hljs-keyword">python</span> -<span class="hljs-keyword">m</span> <span class="hljs-keyword">kmap</span>
</code></pre>
